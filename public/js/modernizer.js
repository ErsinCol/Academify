...
(window.Modernizr = (function (a, b, c) {
    ...
    let k;
    const l = {}.toString;
    const m = 'Webkit Moz O ms';
    var n = m.split(' ');
    var o = m.toLowerCase().split(' ');
    const p = {};
    const q = {};
    const r = {};
    const s = [];
    ...
    !z(v, 'undefined') && !z(v.call, 'undefined')
        ...
        Function.prototype.bind ||
            (Function.prototype.bind = function (b) {
                ...
                const d = t.call(arguments, 1);
                const e = function () {
                    if (this instanceof e) {
                        const a = function () {};
                        a.prototype = c.prototype;
                        const f = new a();
                        const g = c.apply(f, d.concat(t.call(arguments)));
    ...
    return (
        (e.addTest = function (a, b) {
            if (typeof a === 'object')
                for (const d in a) w(a, d) && e.addTest(d, a[d]);
            else {
                a = a.toLowerCase();
                if (e[a] !== c) return e;
    ...
    (function (a, b, c) {
        ...
        var l = a.opera && '[object Opera]' == o.call(a.opera);
