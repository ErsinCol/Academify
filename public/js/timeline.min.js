 ...
 */
'use strict';
const _slicedToArray = function (e, t) {
...
function timeline(e, v) {
    ...
    function a(e, t) {
        ...
        const l = b.verticalTrigger.defaultValue.match(/(\d*\.?\d*)(.*)/);
        let a = t.unit;
        let r = t.value;
        let s = n;
        if ('px' === a && n <= r) {
    ...
    function c(e) {
        const t = `translate3d(-${e.items[o].offsetLeft}px, 0, 0)`;
        d(e.scroller, t);
    }
    function r(e) {
        let a;
        ...
        (o = e.settings.startIndex),
            ...
            (function (e) {
                if (e.items.length > e.settings.visibleItems) {
                    ...
                    const n = e.items[0].offsetHeight;
                    (t.className =
            ...
            (function (e) {
                const t = e.timelineEl.querySelector('.timeline-divider');
                t && e.timelineEl.removeChild(t);
                const i = e.items[0].offsetHeight;
        ...
        g.forEach(function (e) {
            (e.timelineEl.style.opacity = 0),
                ...
                (function (e) {
                    ...
                    const t = e.timelineEl.querySelectorAll(
                        '.timeline-nav-button'
                    );
    ...
    e.length &&
        [].forEach.call(e, function (e) {
            const t = e.id ? `#${e.id}` : `.${e.className}`;
            const i = 'could not be found as a direct descendant of';
            const n = e.dataset;
            let l = void 0;
            let a = void 0;
            let r = void 0;
                    ...
                    'integer' === b[e].type
                        ? (s[e] &&
                              ...
                              'number' === typeof t ||
                                  t % 1 == 0 ||
                                  (console.warn(
                                      `${p} The value "${t}" entered for the setting "${i}" is not an integer.`
                                  ),
                                  0))) ||
                          (s[e] = b[e].defaultValue)
                        : 'string' === b[e].type &&
                          ...
                          (console.warn(
                              `${p} The value "${s[e]}" entered for the setting "${e}" was not recognised.`
                          ),
                          (s[e] = b[e].defaultValue));
            });
            const o = b.verticalTrigger.defaultValue.match(/(\d*\.?\d*)(.*)/);
            const d = s.verticalTrigger.match(/(\d*\.?\d*)(.*)/);
            const c = _slicedToArray(d, 3);
            let m = c[1];
            let u = c[2];
            let f = !0;
            if (
                ...
                'px' !== u &&
                    '%' !== u &&
                    (console.warn(
                        `${p} The setting 'verticalTrigger' must be a percentage or pixel value.`
                    ),
                    (f = !1)),
                '%' === u && (100 < m || m < 0)
                    ? (console.warn(
                          `${p} The 'verticalTrigger' setting value must be between 0 and 100 if using a percentage value.`
                      ),
                      (f = !1))
                    : 'px' === u &&
                      m < 0 &&
                      (console.warn(
                          `${p} The 'verticalTrigger' setting value must be above 0 if using a pixel value.`
                      ),
                      (f = !1)),
                !1 === f)
            ) {
                const h = _slicedToArray(o, 3);
                (m = h[1]), (u = h[2]);
            }
            (s.verticalTrigger = { unit: u, value: m }),
                s.moveItems > s.visibleItems &&
                    (console.warn(
                        `${p} The value of "moveItems" (${s.moveItems}) is larger than the number of "visibleItems" (${s.visibleItems}). The value of "visibleItems" has been used instead.`
                    ),
                    (s.moveItems = s.visibleItems)),
                s.startIndex >= r.length - s.visibleItems
                    ? (console.warn(
                          `${p} The 'startIndex' setting must be between 0 and ${
