                ...
                (t.show = function () {
                    ...
                    if (
                        ...
                        if (
                            ...
                            const o = Cn.getTransitionDurationFromElement(
                                this._element
                            );
                            tt(this._element)
                                .one(Cn.TRANSITION_END, function () {
            ...
            return (
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                ...
                                const r = Cn.getTransitionDurationFromElement(
                                    this._element
                                );
                                Bt(this._element)
                                    .one(Cn.TRANSITION_END, function (t) {
                ...
                (t.dispose = function () {
                    Bt.removeData(this._element, Gt),
                        Bt(window, document, this._element, this._backdrop).off(
                            qt
                        ),
                        (this._config = null),
                        (this._element = null),
                ...
                (t._showElement = function (t) {
                    ...
                    if (n) {
                        const s = Cn.getTransitionDurationFromElement(
                            this._element
                        );
                        Bt(this._dialog)
                ...
                (t._showBackdrop = function (t) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ...
                            return;
                        if (!n) return void t();
                        const i = Cn.getTransitionDurationFromElement(
                            this._backdrop
                        );
                        Bt(this._backdrop)
        ...
        (Se = (function () {
            ...
            return (
                ...
                (t.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        if (oe(this.tip).hasClass(Ee)) {
                            const h = Cn.getTransitionDurationFromElement(
                                this.tip
                            );
                            oe(this.tip)
                ...
                (t.hide = function (t) {
                    ...
                    if (
                        (oe(this.element).trigger(i), !i.isDefaultPrevented())
                    ) {
                        if (
                            (oe(n).removeClass(ye),
                            'ontouchstart' in document.documentElement &&
                ...
                (t._enter = function (t, e) {
                    ...
                    (e = e || oe(t.currentTarget).data(n)) ||
                        ...
                        t &&
                            (e._activeTrigger['focusin' === t.type ? Ae : Ie] =
                                !0),
                ...
                (t._leave = function (t, e) {
                    ...
                    (e = e || oe(t.currentTarget).data(n)) ||
                        ...
                        oe(t.currentTarget).data(n, e)),
                        t &&
                            (e._activeTrigger['focusout' === t.type ? Ae : Ie] =
                                !1),
            ...
            return (
                (t.show = function () {
                    ...
                    if (
                        ...
                        if (e) {
                            const s = 'UL' === e.nodeName ? pn : mn;
                            i = (i = rn.makeArray(rn(e).find(s)))[i.length - 1];
                        }
                        const o = rn.Event(ln.HIDE, {
                        ...
                        if (
                            ...
                            const l = function () {
                                const t = rn.Event(ln.HIDDEN, {
                                    relatedTarget: n._element,
                                });
                                const e = rn.Event(ln.SHOWN, {
                                    relatedTarget: i,
                                });
